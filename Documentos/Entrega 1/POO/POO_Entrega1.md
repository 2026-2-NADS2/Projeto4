# Programação Orientada a Objetos — Entrega 1
...
O backend utiliza um servidor local Node.js/Express e foi estruturado para consultar o banco de dados PostgreSQL hospedado no Neon.
